...
var HrDashboard = Widget.extend(ControlPanelMixin, {
    ...
    events: {
        ...
        'click .hr_pelatihan':'hr_pelatihan',
        'click .hr_perdin':'hr_perdin',
        'click .hr_cuti':'hr_cuti',
        'click .hr_ijin':'hr_ijin',
    },
    ...
    hr_pelatihan: function(e){
        ...
        this.do_action({
            name: _t("Pelatihan"),
            type: 'ir.actions.act_window',
            res_model: 'hr.training.participant',
            view_mode: 'tree,form',
            view_type: 'form',
            domain: [['name', '=', self.login_employee.id]],
            views: [[false, 'list'],[false, 'form']],
            target: 'current'
        })
    },

    hr_perdin: function(e){
        var self = this;
        e.stopPropagation();
        e.preventDefault();
        this.do_action({
    ...
    hr_ijin : function(e){
        ...
        this.do_action({
            ...
            view_mode: 'tree,form',
            view_type: 'form',
            domain: [['employee_id', '=', self.login_employee.id], ['type', '=', 'izin']],
            views: [[false, 'list'],[false, 'form']],
            target: 'current'
        })
    },

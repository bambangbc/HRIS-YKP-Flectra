flectra.define('dynamic_list.controller', function(require) {
    "use strict";
    ...
    var FieldDropdown = require('dynamic_list.FieldDropdown');
    var _t = core._t;
    var QWeb = core.qweb;
    ListController.include({
        ...
        _createFieldsDropdown: function() {
            ...
            var fieldsInfo = state.fieldsInfo['list'];
        ...
        _updateFields: function(event) {
            ...
            var state = this.model.get(this.handle);
            state.fieldsInfo['list'] = event.data.fields;

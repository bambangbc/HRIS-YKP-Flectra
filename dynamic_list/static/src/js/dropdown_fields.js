flectra.define('dynamic_list.FieldDropdown', function(require) {
    "use strict";
    ...
    var FieldDropdown = Widget.extend({
        template: 'dynamic_list.FieldsDropdown',
        fieldTemplate: 'dynamic_list.FieldsDropdownItems',
        events: {
        ...
        init: function(parent, fields, info, arch) {
            ...
            this.fields = _.map(fields, function(field, sequence) {
        ...
        _onSearch: _.debounce(function(event) {
            ...
            _.each(this.fields, function(field) {
                field.invisible = search ? field.id.indexOf(search) < 0 : false;
            });
            this._updateDropdownFields();
        }, 250),
